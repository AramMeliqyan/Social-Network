...
import { getPost, handleComment, handleDeleteComment } from '../helpers/api';
import { IComment, IPost, IContext } from '../helpers/types';
    ...
    handleDeleteComment(id)
      .then(() => {
        if (postInfo) {
          setPostInfo({
            ...postInfo,
            comments: postInfo.comments.filter(comment => comment.id !== id)
          });
        }
      })
  }
