...
export const getFollowers = async (id: number): Promise<IResponse> => {
  const response = await Axios.get(`/account/follower/${id}`);
  return response.data;
};
...
export const getAllFollowers = async (): Promise<IResponse> => {
  const response = await Axios.get("/followers");
  return response.data;
}

export const getAllFollowing = async (): Promise<IResponse> => {
...
export const requestsAccept = async (id: number): Promise<IResponse> => {
